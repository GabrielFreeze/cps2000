...
Lexer::Lexer() {
    ...
    dfa =/*LETTER       :*/ {{S_ID           , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_ID   ,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*LETTER       */
         ...
         /*OPEN_BRACKET :*/  {S_OPEN_BRACKET , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*OPEN_BRACKET */
         /*CLOSE_BRACKET:*/  {S_CLOSE_BRACKET, S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*CLOSE_BRACKET*/
         /*OPEN_CURLY   :*/  {S_OPEN_CURLY   , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*OPEN_CURLY   */
         /*CLOSE_CURLY  :*/  {S_CLOSE_CURLY  , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*CLOSE_CURLY  */
         /*SEMICOLON    :*/  {S_SEMICOLON    , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*SEMICOLON    */
         /*COLON        :*/  {S_COLON        , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*COLON        */
         /*COMMA        :*/  {S_COMMA        , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*COMMA        */
         /*QUOTE        :*/  {S_A            , S_B    ,  S_CHAR_LIT,S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*QUOTE        */
         /*EQUAL        :*/  {S_EQUAL        , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_RELOP_C,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_RELOP_C,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_RELOP_B,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*EQUAL        */
         /*PERIOD       :*/  {S_EMPTY        , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_C    ,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*PERIOD       */
         /*BANG!        :*/  {S_F            , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*BANG!        */
         /*DIV          :*/  {S_MULOP_A      , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,  S_COMMENT_B,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_COMMENT_A,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*DIV          */
         /*MUL          :*/  {S_MULOP_B      , S_B    ,  S_EMPTY,   S_EMPTY,  S_E     ,     S_E     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_D        ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*MUL          */
         /*ADD          :*/  {S_ADDOP_A      , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*ADD          */
         /*SUB          :*/  {S_ADDOP_B      , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*SUB          */
         /*LESS         :*/  {S_RELOP_A      , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*LESS         */
         /*GREATER      :*/  {S_RELOP_A      , S_B    ,  S_EMPTY,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_EMPTY,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_ARROW,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*GREATER      */
         /*UNDERSCORE   :*/  {S_ID           , S_B    ,  S_B    ,   S_EMPTY,  S_D     ,     S_D     ,  S_EMPTY  ,   S_EMPTY,   S_ID   ,    S_EMPTY,       S_EMPTY,     S_EMPTY,    S_EMPTY,     S_EMPTY,  S_EMPTY,  S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY, S_EMPTY    ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_EMPTY  ,   S_EMPTY,   S_EMPTY,   S_EMPTY,   S_COMMENT_A,    S_EMPTY}, /*UNDERSCORE   */
...
vector<Token> Lexer::getTokens(string input_text) {
    ...
    for (int i = 0; i < input_text.size(); i++) {
        ...
        //If the current state is the empty state then attempt to retrieve the token.
            ...
            Token token = {type,current_lexeme, nl_counter+1, int(char_counter-current_lexeme.size())};
